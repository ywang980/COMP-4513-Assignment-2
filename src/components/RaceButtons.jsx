    ...
    return (
        <div className="flex justify-around">
            <div className="w-1/2 p-1">
                <button onClick={handleResultsClick} className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Results
                </button>
            </div>
            <div className="w-1/2 p-1">
                <button onClick={handleStandingsClick} className="w-full bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Standings
                </button>
            </div>
        </div>
